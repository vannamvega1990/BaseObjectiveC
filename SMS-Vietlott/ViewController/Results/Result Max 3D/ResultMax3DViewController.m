...
@interface ResultMax3DViewController ()

@end

@implementation ResultMax3DViewController {
    int page;
    int line;
    BOOL isCanLoadMore;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellIdentifier = @"ResultMax3DTableViewCell";
    ResultMax3DTableViewCell *cell = (ResultMax3DTableViewCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (cell == nil) {
